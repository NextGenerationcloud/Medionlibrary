<?php
$TRANSLATIONS = array(
"Medionlibrarys" => "Marcatores de libro",
"Bookm." => "Marcat.",
...
"Are you sure you want to remove this medionlibrary?" => "Es tu secur de voler remover iste marcator?",
"Warning" => "Aviso",
...
"Add a medionlibrary" => "Adde un marcator de libro",
"This URL is already medionlibraryed! Overwrite?" => "Iste URL es jam inter le marcatores! Superscriber?",
...
"Edit" => "Modificar",
"Cancel" => "Cancellar",
"Drag this to your browser medionlibrarys and click it, when you want to medionlibrary a webpage quickly:" => "Trahe isto in tu marcatores de libro de navigator e pulsa, quando tu vole memorar un pagina web rapidemente:",
"Add to ownCloud" => "Adde a ownCloud",
"Address" => "Adresse",
"Filterable Tags" => "Etiquettas filtrabile",
"You have no medionlibrarys" => "Tu non ha marcatores de libro",
"You can also import a medionlibrary file" => "Tu pote etiam importar un file de marcatores de libro",
