OC.L10N.register(
    ...
    "Tags" : "標籤",
    "Filter by tag" : "依標籤篩選",
    "Are you sure you want to remove this medionlibrary?" : "你確定你要移除此書籤？",
    "Warning" : "警告",
    "Are you sure you want to remove this tag from every entry?" : "您確定要從每個項目中移除這個標籤嗎？",
    "Import error" : "匯入錯誤",
    "Import completed successfully." : "匯入成功完成。",
    "Uploading..." : "上傳中...",
    "Add a medionlibrary" : "新增書籤",
    "This URL is already medionlibraryed! Overwrite?" : "此網址已經存在書籤中，確定要複寫？",
    ...
    "Edit" : "編輯",
    "Cancel" : "取消",
    "Drag this to your browser medionlibrarys and click it, when you want to medionlibrary a webpage quickly:" : "把這個拖曳至瀏覽器的書籤列，下次您想要將某個頁面加至書籤時，點一下書籤列上面的這個項目即可。",
    "Add to ownCloud" : "新增至ownCloud",
    "Address" : "網址",
    "Filterable Tags" : "可篩選的標記",
    "You have no medionlibrarys" : "您還沒有任何書籤",
    "You can also import a medionlibrary file" : "你也可以匯入書籤檔案",
