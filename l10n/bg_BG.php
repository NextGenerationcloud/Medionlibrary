...
"Are you sure you want to remove this medionlibrary?" => "Сигурен ли си, че искаш да премахнеш отметката?",
...
"Uploading..." => "Качване...",
"Add a medionlibrary" => "Добави отметка",
"This URL is already medionlibraryed! Overwrite?" => "Това URL вече е отбелязано! Презаписване?",
...
"Edit" => "Промяна",
"Cancel" => "Отказ",
"Drag this to your browser medionlibrarys and click it, when you want to medionlibrary a webpage quickly:" => "Довлачи това в лентата с отметки на браузъра си и го натискай, когато искаш да отметнеш бързо някоя страница:",
"Add to ownCloud" => "Добави в ownCloud",
"Address" => "Адрес",
"Filterable Tags" => "Етикети подлежащи на Филтриране",
"You have no medionlibrarys" => "Нямаш отметки",
"You can also import a medionlibrary file" => "Можеш също да заредиш файл с отметки",
"Medionlibrarylet" => "Отметка",
